...
int main(int argc, char** argv) {
    ...
    pthread_create(&thread7, NULL, writer, NULL);
    pthread_create(&thread8, NULL, writer, NULL);
    pthread_create(&thread9, NULL, writer, NULL);
    pthread_create(&thread10, NULL, writer, NULL);
